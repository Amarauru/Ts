...
//array objeto
let idiomas = ['Portugues', 'Ingles', 'Frances', 'Japones'];
//array normal
let frutas = ['Maçã', 'Abacaxi', 'Laranja', 'Pera'];
//experimentando laço
...
let listaFrutas = ['Maçã', 'Abacaxi', 'Laranja', 'Pera'];
...
let listaTeste = [5, true, ...listaFrutas];
